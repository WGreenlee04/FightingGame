	...
	public void run() {
		...
		while (running) {
			...
			if (space.isRunnableP2()) {
				...
				} else if (space.getPlayers()[i].getJumps() > 2 && !space.getPlayers()[i].isDark()) { // darker color,
																										// out
																										// of jumps
				...
				} else if (space.getPlayers()[i].getJumps() == 0 && space.getPlayers()[i].isDark()) { // you can be
																										// light
					space.getPlayers()[i].setImage(
